...
// importing redux hooks to dispatch actions and use store
...
// importing functions from contact Reducers
import { contactSelector, addContactThunk } from "../Redux/Reducers/contactReducer";


// importing function to render add contact section
const AddContact = () => {

    //dispatching an action
    const dispatch = useDispatch();

    //checking whether user made some changes in data or not
    ...
    // storing changes made inside the initial data 
    const [formData,setFormData]  = useState(inputStructure);
    // storing the address of user
    ...
    const handleSubmit = (e) => {
        ...
        // if changes are not made in the data
        if(!isChanged){
    ...
    //handling the changes made inside the input fields in form and store the data in state variables
    const handleChange = (e) => {
        // setting is changed value to true so that user can submit the data
        if(!isChanged){
            setIsChanged(true);
        }
        ...
        // storing the data inside the object at their position
        setFormData({
            ...formData,
            [name]:value,
        });
    ...
    // storing changes made inside the address section of the form
    const handleAddressChange = (e) => {
        ...
        // appending the address inside the main data object 
        setFormData({
            ...formData,
            address:{
                ...address,
    ...
    const handleReset = (e) => {
        ...
        // setting ischangeg value to false so that user cannot submit the empty data
        setIsChanged(false);
    ...
    <>
        ...
        {/* button to reset the entered values  */}
