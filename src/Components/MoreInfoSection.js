...
//  importing functions and selector from contact reducer
import { contactSelector, setShowAddContact,} from "../Redux/Reducers/contactReducer";

// components to render on screen

// imporitng for Update section
import UpdateSection from "./UpdateSection";
// importing to add contact section
import AddContact from "./AddContact";


// rendering the moreInfo section on the page
